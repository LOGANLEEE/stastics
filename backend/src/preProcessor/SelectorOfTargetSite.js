...
const Bullpen = {
	...
	hitCount:
		'#container > div.contents > div.left_cont > ul > li > div.text > div.text_left > div.text2 > span:nth-child(4)',
};
...
const Gasengi = {
	...
	author:
		'#view_conta > table > tbody > tr > td > table:nth-child(4) > tbody > tr:nth-child(1) > td > div:nth-child(1) > a > span',
	date: '#view_conta > table > tbody > tr > td > div:nth-child(1) > div:nth-child(1) > span',
	hitCount:
		'#view_conta > table > tbody > tr > td > table:nth-child(4) > tbody > tr:nth-child(1) > td > div:nth-child(2)',
};
const RuliWeb = {
	title: '#board_read > div > div.board_main > div.board_main_top > div.user_view > div:nth-child(1) > h4 > span',
	author:
		'#board_read > div > div.board_main > div.board_main_top > div.user_view > div:nth-child(4) > div.col.user_info_wrapper > div > p:nth-child(1) > strong',
	date:
		'#board_read > div > div.board_main > div.board_main_top > div.user_view > div:nth-child(4) > div.col.user_info_wrapper > div > p:nth-child(6) > span.regdate',
	hitCount:
		'#board_read > div > div.board_main > div.board_main_top > div.user_view > div:nth-child(4) > div.col.user_info_wrapper > div > p:nth-child(5)',
};
const PpomPu = {
	title:
...
const FmKorea = {
	...
	hitCount:
		'#bd_capture > div.rd_hd.clear > div.board.clear > div.btm_area.clear > div.side.fr > span:nth-child(1) > b',
};
const TheQoo = {
	title:
	...
	author:
		'#content > div > div.bd_load_target.bd.clear.hover_effect > div.rd.rd_nav_style2.clear > div.rd_hd.clear > div.board.clear > div > div:nth-child(1)',
	date:
		'#content > div > div.bd_load_target.bd.clear.hover_effect > div.rd.rd_nav_style2.clear > div.rd_hd.clear > div.board.clear > div > div.side.fr > span',
	hitCount:
...
const DogDrip = {
	...
	author:
		'#main > div > div.eq.section.secontent.background-color-content > div > div.ed.article-wrapper.inner-container > div.ed > div.ed.article-head.margin-bottom-large > div.ed.flex.flex-wrap.flex-left.flex-middle.title-toolbar > div.ed.flex.flex-wrap > span:nth-child(1) > a',
	date: '',
	hitCount: '',
};
